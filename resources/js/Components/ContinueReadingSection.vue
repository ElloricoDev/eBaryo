...
<template>
  <div class="mb-8 border-2 border-green-400 bg-green-50 rounded-xl shadow-lg p-4 relative">
    ...
    <div v-if="continueReadingList.length" class="relative">
      ...
      <!-- Book List -->
      <div ref="scrollRowRef" class="section-scroll-row hide-scrollbar md:justify-center md:gap-6">
        <BookCard

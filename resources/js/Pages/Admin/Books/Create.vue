...
<template>
  ...
  <div class="max-w-6xl mx-auto px-4 py-6">
    <div class="flex items-center gap-4 mb-6">
      <Link :href="route('admin.books.index')" class="px-4 py-2 border border-green-600 text-green-700 hover:bg-green-600 hover:text-white font-semibold rounded-full shadow-sm transition flex items-center gap-2">
        <font-awesome-icon icon="arrow-left" /> Back
      </Link>
      <h1 class="text-2xl font-bold text-green-700 flex items-center gap-2">
        <font-awesome-icon icon="plus-square" /> Add Book
      </h1>
    </div>

    ...
    <div class="bg-gradient-to-br from-white via-green-50 to-green-100 border-2 border-green-400 rounded-2xl shadow-2xl p-8">
      <form @submit.prevent="submit" class="space-y-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="relative">
            ...
            <input v-model="form.first_name" type="text"
              class="w-full border border-green-400 rounded-full pl-10 pr-4 py-2 shadow-sm focus:ring-2 focus:ring-green-300 focus:outline-none"
        ...
        <div>
          <button
            type="submit"
            class="w-full bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white font-bold py-3 px-6 rounded-full shadow-xl inline-flex items-center justify-center gap-2"

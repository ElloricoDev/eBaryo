...
import { faRightToBracket, faPerson, faLock, faEnvelope, faUserPlus, faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons'
import { faGoogle } from '@fortawesome/free-brands-svg-icons'
import { ref } from 'vue'

library.add(faRightToBracket, faPerson, faLock, faEnvelope, faUserPlus, faGoogle, faEye, faEyeSlash)
...
<template>
    ...
    <GuestLayout>
        <div class="flex flex-col items-center justify-center px-4 relative overflow-hidden">
            ...
            <div class="w-full max-w-md bg-white border-2 border-green-600 rounded-2xl shadow-md p-6 mt-2 transition duration-200 hover:shadow-lg hover:border-green-700 animate-slide-up">
                <h1 class="text-center text-green-700 text-2xl font-semibold mb-6">
                    <font-awesome-icon icon="right-to-bracket" class="mr-2"/> Login
                </h1>
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword" tabindex="-1" class="absolute right-3 top-3 text-green-400 hover:text-green-600 focus:outline-none" :aria-label="showPassword ? 'Hide password' : 'Show password'">
                        ...
                        <div class="text-right mt-2">
                            <Link :href="route('password.request')" class="text-green-700 text-sm hover:underline">
                                <font-awesome-icon icon="envelope" /> Forgot password?
                            </Link>
                        </div>
                    </div>
                    <!-- Remember Me -->
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span v-else>
                                <svg class="animate-spin h-5 w-5 mr-2 inline-block text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg>
                                Logging in...
                            </span>
                        </button>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            <font-awesome-icon :icon="['fab', 'google']" class="mr-2"/> Login with Google
                        </a>
                    </div>
                </form>
                <!-- Register Link -->

...
import { faUserPlus, faPerson, faEnvelope, faLock, faRightToBracket } from '@fortawesome/free-solid-svg-icons'
import { faGoogle } from '@fortawesome/free-brands-svg-icons'

library.add(faUserPlus, faPerson, faEnvelope, faLock, faRightToBracket, faGoogle)
            ...
            >
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="relative">
                        ...
                        <div v-if="form.errors.user_name" class="text-sm text-red-600 mt-1">
                ...
                <div class="text-center mt-6">
                    <font-awesome-icon icon="right-to-bracket" class="text-green-700"/>
                    <Link
                        :href="route('login')"

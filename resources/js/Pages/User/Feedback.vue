...
<template>
    ...
    <div class="relative min-h-screen">
        ...
        >
            <h1
                class="text-2xl font-bold mb-6 text-green-700 flex items-center gap-2"
            >
                <font-awesome-icon icon="comment-dots" /> Submit Feedback
            </h1>

            <div
                class="bg-white border-2 border-green-600 rounded-xl shadow-md p-2 sm:p-6 hover:border-green-700 transition"
            >
                <form @submit.prevent="submit">
                    <div class="mb-4">
                        <label
                            for="message"
                            class="block text-green-700 font-medium mb-2"
                            >Your Feedback</label
                        >
                        <textarea
                        ...
                        <div
                            ...
                            class="text-red-600 text-sm mt-1 animate-fade-in"
                        >
                            {{ form.errors.message }}
                        </div>
                    </div>
                    ...
                    <div
                        v-if="!isVerified"
                        class="text-yellow-600 text-center mt-2"
                    >

...
<template>
    ...
    <div class="relative min-h-screen">
        ...
        >
            ...
            <div
                class="bg-white border-2 border-green-600 rounded-xl shadow-md hover:border-green-700 transition"
            >
                <div class="overflow-x-auto">
                    <table
                        class="min-w-full table-auto text-sm text-left text-gray-700"
                    >
                        <thead
                            class="bg-green-100 text-green-800 uppercase text-xs font-semibold"
                        >
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr v-if="!props.feedbacks.length">
                                <td
                                    colspan="4"
                                    class="px-4 py-10 text-center text-gray-500 animate-fade-in"
                                >
                                    <div

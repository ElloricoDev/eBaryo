...
import { faShieldHalved, faKey, faArrowRotateRight } from '@fortawesome/free-solid-svg-icons';
...
<template>
  <div class="relative animate-fade-in bg-white bg-opacity-90 border-2 border-green-600 rounded-2xl shadow-xl mb-6 overflow-hidden">
    ...
    <div class="p-6">
      <div v-if="isGoogleUser" class="bg-blue-100 text-blue-800 px-4 py-3 rounded mb-4 text-sm">
      ...
      <form v-else @submit.prevent="submit" class="space-y-4">
        ...
        <div class="relative">
          ...
          />
          <label for="current_password" class="absolute left-3 top-2 text-green-700 font-medium pointer-events-none transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-focus:-top-4 peer-focus:text-xs peer-focus:text-green-600 bg-white px-1">
        ...
        <div class="relative">
          ...
          />
          <label for="new_password" class="absolute left-3 top-2 text-green-700 font-medium pointer-events-none transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-focus:-top-4 peer-focus:text-xs peer-focus:text-green-600 bg-white px-1">
        ...
        <div class="relative">
          ...
          />
          <label for="password_confirmation" class="absolute left-3 top-2 text-green-700 font-medium pointer-events-none transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-focus:-top-4 peer-focus:text-xs peer-focus:text-green-600 bg-white px-1">

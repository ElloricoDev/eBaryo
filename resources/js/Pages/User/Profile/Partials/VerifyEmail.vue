...
import { faEnvelopeCircleCheck, faKey, faPaperPlane } from '@fortawesome/free-solid-svg-icons';
...
<template>
  <div class="relative animate-fade-in bg-white bg-opacity-90 border-2 border-green-600 rounded-2xl shadow-xl mb-6 overflow-hidden">
    ...
    <div class="p-6">
      <div v-if="isVerified" class="bg-green-100 border border-green-300 text-green-700 px-4 py-3 rounded mb-4">
      ...
      <form @submit.prevent="submit" class="space-y-4">
        <div v-if="!isGoogleUser && !isVerified" class="relative">
          <input
            ...
            :disabled="isVerified"
          />
          <label for="verify_password" class="absolute left-3 top-2 text-green-700 font-medium pointer-events-none transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-focus:-top-4 peer-focus:text-xs peer-focus:text-green-600 bg-white px-1">
